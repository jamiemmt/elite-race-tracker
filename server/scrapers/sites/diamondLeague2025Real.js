...
/**
 * Real 2025 Diamond League Results Scraper
 * Contains manually curated results from the actual 2025 season
 */
class DiamondLeague2025Real extends BaseScraper {
  constructor() {
    super('diamondLeague2025Real', 'https://diamondleague.com');
  }
...
module.exports = new DiamondLeague2025Real();
